        ...
        responsive: [
            {
                breakpoint: 640,
                settings: {
                    slidesToShow: testimonials.length >= 2 ? 2 : 1,
            ...
            },
            {
                breakpoint: 1024,
                settings: {
                    slidesToShow: testimonials.length >= 3 ? 3 : testimonials.length || 1,
            ...
            <div className="container mx-auto px-4 md:px-12">
                ...
                <div className="relative">
                    {isPending ? (
                        ...
                        <Slider key={testimonials.length} {...settings} className="testimonial-slider">
